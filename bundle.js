...
/***/ function(module, exports, __webpack_require__) {
	...
	var playEvents = __webpack_require__(9);
...
/***/ function(module, exports) {
	...
	var testColumns = function testColumns(board) {
	...
	var testRows = function testRows(board) {
	...
	var testDiagonals = function testDiagonals(board) {
	...
	var whoIsWinner = function whoIsWinner(board) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onGetIndexGames = function onGetIndexGames(event) {
	  event.preventDefault();
	  api.indexGames().done(ui.indexGamesSuccess).fail(ui.failure);
	};
	...
	var onPlayerMove = function onPlayerMove(event) {
	  ...
	  var divID = /\d/.exec($(event.target).attr('id'))[0];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getPreviousGame = function getPreviousGame(data) {
	  return $.ajax({
